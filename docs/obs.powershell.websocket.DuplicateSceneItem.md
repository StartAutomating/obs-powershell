...
### Syntax
```PowerShell
Copy-OBSSceneItem [[-SceneName] <String>] [[-SceneUuid] <String>] [-SceneItemId] <Double> [[-DestinationSceneName] <String>] [[-DestinationSceneUuid] <String>] [-PassThru] [-NoResponse] [<CommonParameters>]
```
