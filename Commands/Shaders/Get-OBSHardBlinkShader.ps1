function Get-OBSHardBlinkShader {

[Alias('Set-OBSHardBlinkShader','Add-OBSHardBlinkShader')]
param(
# Set the timeon of OBSHardBlinkShader
[ComponentModel.DefaultBindingProperty('timeon')]
[Single]
$Timeon,
# Set the timeoff of OBSHardBlinkShader
[ComponentModel.DefaultBindingProperty('timeoff')]
[Single]
$Timeoff,
...
process {
$shaderName = 'hard_blink'
$ShaderNoun = 'OBSHardBlinkShader'
