...
### Syntax
```PowerShell
Get-OBSBloomShader [[-AngleSteps] <Int>] [[-RadiusSteps] <Int>] [[-AmpFactor] <Float>] [[-Notes] <String>] [[-SourceName] <String>] [[-FilterName] <String>] [[-ShaderText] <String>] [-Force <Switch>] [-PassThru <Switch>] [-NoResponse <Switch>] [-UseShaderTime <Switch>] [<CommonParameters>]
```
